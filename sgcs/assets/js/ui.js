...
export const ui = {
  async renderLayout(activePath, breadcrumbs) {
    ...
    wrapper.insertAdjacentHTML('afterbegin', uiComponents.getSidebar(activePath));
    wrapper.insertAdjacentHTML('afterbegin', uiComponents.getHeader(breadcrumbs));
