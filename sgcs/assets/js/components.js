export const uiComponents = {
  ...
  <aside class="fixed left-0 top-0 h-full w-64 bg-primary text-on-primary z-50 flex flex-col justify-between shadow-[0_1px_8px_rgba(0,0,0,0.04)]">
    <div class="flex flex-col">
      ...
      <nav class="flex flex-col gap-space-2xs px-space-xs">
        <a href="/dashboard.html" class="flex items-center gap-space-sm px-space-sm py-space-xs rounded transition-colors ${activePath === 'dashboard' ? 'bg-primary-container text-on-primary font-bold shadow-sm' : 'text-on-primary-container hover:bg-primary-container/60 hover:text-on-primary'}">
          <i data-lucide="layout-dashboard" class="w-5 h-5"></i>
          <span class="font-label-md text-label-md">Dashboard</span>
        </a>
        <a href="/chamados/" class="flex items-center justify-between px-space-sm py-space-xs rounded transition-colors ${activePath === 'chamados' ? 'bg-primary-container text-on-primary font-bold shadow-sm' : 'text-on-primary-container hover:bg-primary-container/60 hover:text-on-primary'}">
        ...
        <a href="/condominios/" class="flex items-center gap-space-sm px-space-sm py-space-xs rounded transition-colors ${activePath === 'condominios' ? 'bg-primary-container text-on-primary font-bold shadow-sm' : 'text-on-primary-container hover:bg-primary-container/60 hover:text-on-primary'}">
          <i data-lucide="building-2" class="w-5 h-5"></i>
          <span class="font-label-md text-label-md">Condomínios</span>
        </a>
        <a href="/configuracoes/tipos-chamado.html" class="flex items-center gap-space-sm px-space-sm py-space-xs rounded transition-colors ${activePath === 'tipos-chamado' ? 'bg-primary-container text-on-primary font-bold shadow-sm' : 'text-on-primary-container hover:bg-primary-container/60 hover:text-on-primary'}">
          <i data-lucide="tags" class="w-5 h-5"></i>
          <span class="font-label-md text-label-md">Tipos de Chamado</span>
        </a>
        <a href="/configuracoes/perfil.html" class="flex items-center gap-space-sm px-space-sm py-space-xs rounded transition-colors ${activePath === 'configuracoes' ? 'bg-primary-container text-on-primary font-bold shadow-sm' : 'text-on-primary-container hover:bg-primary-container/60 hover:text-on-primary'}">
  ...
  <header class="fixed top-0 left-64 right-0 h-16 bg-surface-container-lowest/90 backdrop-blur-xl shadow-[0_1px_8px_rgba(0,0,0,0.04)] z-40 flex items-center justify-between px-[2rem]">
    ...
    <div class="flex items-center gap-[1rem]">
      ...
      <div class="flex items-center gap-[0.75rem] cursor-pointer p-[0.25rem] rounded hover:bg-surface-container-high transition-colors" onclick="window.location.href='/configuracoes/perfil.html'">
